          ...
          <div className='flex'>
            ...
            <div className='mx-24 my-auto'>
              ...
              <Text className='text-[16px]'>
                ...
                sang trọng và tiện nghi. Mỗi khách sạn được chúng tôi lựa chọn kỹ lưỡng, từ vị trí trung tâm thuận lợi
                đến những dịch vụ đẳng cấp quốc tế. Dù bạn đang tìm kiếm sự thư giãn trong những khu nghỉ dưỡng yên tĩnh
                hay không gian sôi động của thành phố, Btravel luôn sẵn sàng đồng hành cùng bạn trên mọi hành trình. Hãy
                để chúng tôi giúp bạn tận hưởng kỳ nghỉ trọn vẹn nhất!
              </Text>
            </div>
          </div>
        </div>
