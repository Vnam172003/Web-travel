          ...
          <div className='col-span-3 mx-10'>
            ...
            <div className='mt-3'>
              ...
              <Title level={5}>
                ...
                sinh, bếp nhỏ và hai ban công. KHÔNG CÓ KHÔNG GIAN nào ĐƯỢC CHIA SẺ với bất KỲ AI khác. Nằm trên mái nhà
                của Paris và hướng về phía nam, nó sẽ làm bạn thích thú với sự quyến rũ, ánh sáng và sự thoải mái của
                nó. Nó nằm ở vị trí lý tưởng giữa Montmartre và Canal Saint-Martin, và chỉ cách Gare du Nord và Gare de
                l'Est một quãng ngắn. Đó là một điểm dừng từ sân vận động Olympic. Chỗ ở cho thuê dài hạn cũng có sẵn.
              </Title>
            </div>
            ...
            <Title level={5}>
              ...
              điển từ những năm 1940-50. Nó cung cấp tất cả sự thoải mái bạn cần: hệ thống sưởi trung tâm, kính hai lớp,
              giường và ga trải giường thoải mái, máy pha cà phê, bếp lò để nấu ăn, vòi sen đi bộ tuyệt vời và kết nối
              internet wifi. Xin lưu ý rằng trong khi nhà bếp hoàn hảo để chuẩn bị bữa sáng và bữa trưa/bữa tối nhẹ, nó
              không được thiết kế để nấu các bữa ăn phức tạp. Nếu bạn có bất kỳ thắc mắc nào khác, vui lòng liên hệ với
              chúng tôi. Chúng tôi rất mong được chào đón bạn!
            </Title>
          </div>
          {/* Infor */}
